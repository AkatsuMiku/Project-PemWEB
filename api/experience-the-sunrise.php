...
<body>
    <div class="container-fluid">
        ...
        <div class="container my-5">
            <!-- Back Button -->
            <div class="mb-4">
                <a href="/api/index.php" class="btn btn-outline-primary rounded-pill px-4">
            ...
            <div class="row g-5">
                ...
                <!-- Tips Praktis (Right Column) -->
                <div class="col-lg-4">
                    <div class="modal-tips-container p-4 rounded-4 shadow-sm">
                        <h5 class="tips-heading fw-bold mb-3">
